...
const Team = (props) => {
    ...
    const generarGoleo = () => {
        ...
        let arr = []
        let goleadores = jugadores.filter(x=>x.equipo == props.idTeam)
    ...
    const showPhoto = (id) => {
        ...
        if (arr.length > 0 ){
            return (
                <img src={arr[0].imagen}  alt="imagen"  width="300px" height="200px"/>
            )
    ...
    const showShield = (id) => {
        ...
        if (arr.length > 0 ){
            return (
                <img src={arr[0].imagen}  alt="imagen" width="90px" height="120px"/>
            )
